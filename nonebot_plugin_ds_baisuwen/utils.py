...
def get_hparams(init=True):
    ...
    parser.add_argument('-c', '--config', type=str, default="D:\VITS\VITS-fast-fine-tuning-webui-v1.1\VITS-fast-fine-tuning-webui-v1.1\configs\modified_finetune_speaker.json",
